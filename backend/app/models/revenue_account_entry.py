...
class RevenueAccountEntry(Base):
    """Detalle de INGRESOS por cuenta × departamento × mes (Clase 4), del GL.

    Análogo a OpexEntry/CostEntry pero para revenue. Alimenta el reporte de
    ingresos por cuenta de los históricos. Una fila por (scenario, dept, account).
    """
    __tablename__ = "revenue_account_entries"
    __table_args__ = (
